...
class EncryptTest < Minitest::Test
  ...
  def test_apply_a_shift
    enigma = Enigma.new
    assert_equal ["k"], enigma.encrypt_message("h", "02715", "040895")
  end
  ...
  def test_apply_a_decrypt_shift
    enigma = Enigma.new(-1)
    assert_equal ["h"], enigma.encrypt_message("k", "02715", "040895")
  end

  def test_apply_all_decrypt_shifts
    enigma = Enigma.new(-1)
    expected = ["h", "e", "l", "l", "o"]
    assert_equal expected, enigma.encrypt_message("keder", "02715", "040895")
  end
